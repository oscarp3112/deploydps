...
function App() {
    const baseUrl = "https://dpsoscarpalacios.000webhostapp.com/mascotas.php";
            ...
            <Modal isOpen={modalInsertar}>
                ...
                <ModalBody>
                    <div className="form-group">
                        ...
                        <br />
                        <input type="text" className="form-control" name="iddueno" onChange={handleChange} />
                        <br />
                        <label>Notas: </label>
                        <br />
            ...
            <Modal isOpen={modalEditar}>
                ...
                <ModalBody>
                    <div className="form-group">
                        ...
                        <label>Id dueño: </label>
                        <br />
                        <input type="text" className="form-control" name="iddueno" onChange={handleChange} value={mascotaSeleccionada && mascotaSeleccionada.iddueno} />
                        <br />
                        <label>Notas: </label>
                        <br />
